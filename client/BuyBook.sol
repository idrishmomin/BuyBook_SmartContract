...
contract CourseRegistration is Ownable {
    ...
    constructor(uint256 _bookValue) Ownable(msg.sender) {
        buyBook = _bookValue;
    }

    function payForBook(string memory email) public payable {
        require(msg.value == buyBook, "Payment must be equal to the book value");
